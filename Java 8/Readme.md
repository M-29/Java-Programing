...
**Imp:-** A Lambda expression is an object which is an instance of one functional interface implementation class which is internally generated by compiler dynamically through a lambda expression. 
